...
<p class="aloha_intro"><strong>Thank you for installing Locations!</strong> This page is here to help you get up and running. If you're already familiar with Locations, you can skip it and <a href="<?php echo $settings_url; ?>">continue to the Basic Settings page</a>. </p>
...
<ul class="getting_started_steps">
	<li>
		...
		<div style="background-color: #f4fbff; border: 1px solid lightskyblue; padding: 10px 20px;">
			<p><a href="<?php echo $google_maps_link; ?>" class="button">Get A Free Google Maps API Key</a> &nbsp; <a href="<?php echo $google_maps_link; ?>" class="button">Get A Free Google Geocoding API Key</a></p>
		...
		<p>Once you have obtained your free API key from Google, enter it on the <a href="<?php echo admin_url('edit.php?post_type=location&page=locations-settings#tab-general_settings'); ?>">Locations Settings page, under the General Settings tab</a>. You can find this page by visiting the Locations &raquo; Settings menu in WordPress.</p>
	</li>
	...
	<li>
		...
		<p><a href="<?php echo $new_post_link; ?>" class="button">Add a New Location</a></p>
...
<div class="three_col" style="border-top:1px solid #eee; padding-top: 20px">
	...
	<div class="col">
		...
		<ul>
			...
			<li><a href="https://goldplugins.com/documentation/before-after-documentation/before-after-pro-configuration-and-usage-instructions/<?php echo $utm_str; ?>">Getting Started With Locations</a></li>
	...
	<div class="col">
		...
		<ul>
			<li><a href="https://goldplugins.com/documentation/before-after-documentation/<?php echo $utm_str; ?>">Locations Documentation</a></li>
