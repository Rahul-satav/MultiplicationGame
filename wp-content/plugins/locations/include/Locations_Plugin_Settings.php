					...
					<div class="gp_upgrade_body">
						...
						<div class="header_wrapper">
							<div class="gp_slideshow">
								<ul>
									<li class="slide"><img src="<?php echo $img_base_url . 'import-export.png'; ?>" alt="Screenshot of Import Wizard - &amp; Export Wizard" /><div class="caption">The Import &amp; Export Wizard supports over 200 file types!</div></li>
									<li class="slide"><img src="<?php echo $img_base_url . 'locations-directory-widget.png'; ?>" alt="Screenshot of Store Directory Widget with Google Map and Clustering feature" /><div class="caption">The Store Directory Widget supports many locations with ease</div></li>
									<li class="slide"><img src="<?php echo $img_base_url . 'list-of-locations.png'; ?>" alt="Screenshot of List of Locations in Search Results" /><div class="caption">Visitors can easily your locations by City and State</div></li>
								</ul>
							...
							<div class="customer_testimonial">
									...
									<p class="author">&mdash; <?php echo $upgrade_page_settings['testimonial']['name']; ?></p>
							</div>
						</div>
