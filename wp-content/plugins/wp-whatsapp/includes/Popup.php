...
class Popup
{
    ...
    public function enqueue_global_scripts_styles(){
        ...
        wp_enqueue_script('nta-wa-libs', Helper::AssetResolve('libs/njt-whatsapp.js'), ['jquery'], NTA_WHATSAPP_VERSION, true);
        ...
        wp_register_script('nta-js-global', NTA_WHATSAPP_PLUGIN_URL . 'assets/js/whatsapp-button.js', ['jquery'], NTA_WHATSAPP_VERSION, true);
    ...
    public function enqueue_scripts_styles($activeAccounts, $displayOption)
    {
        ...
        wp_register_script('nta-js-popup', NTA_WHATSAPP_PLUGIN_URL . 'assets/js/whatsapp-popup.js', ['jquery']);
